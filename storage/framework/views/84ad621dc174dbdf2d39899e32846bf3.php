...
<body class="g-has-sticky">
    ...
    <header class="g-header" id="gHeader">
        ...
        <div class="g-header-right">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="g-btn-ghost">Login</a>
                <a href="<?php echo e(route('register')); ?>" class="g-btn-accent">Register</a>
            <?php endif; ?>
        </div>
    </header>
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="g-category-item">
                            <div class="g-category-row">
                                <span class="g-category-name"><?php echo e($cat->name); ?></span>
                                <a href="<?php echo e(route('products.byCategory', $cat)); ?>" class="g-category-link">View →</a>
                            </div>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
                    ...
                    <?php if($products->count() > 0): ?>
                        ...
                        <div class="g-sort-wrap">
                            ...
                            <select id="sort-by-select" class="g-sort-select" aria-label="Sort products">
                                ...
                                <option value="<?php echo e($sortPriceDesc); ?>"   <?php echo e((isset($sort) && $sort === 'price_desc')   ? 'selected' : ''); ?>>Price: High → Low</option>
    ...
    (function () {
        ...
        var suggestUrl  = '<?php echo e(route("search.suggestions")); ?>';
        var debounce    = null;
