...
<?php if($toastMessage !== ''): ?>
    <div id="g-toast-host" style="position: fixed; inset: auto 0 0 0; z-index: 9999; pointer-events: none;">
        <div
            ...
            role="status"
            aria-live="polite"
            data-type="<?php echo e($toastType); ?>"
            style="
                pointer-events: none;
                position: fixed;
                left: 12px;
        ...
        >
            <span
                ...
                style="
                    ...
                    border-radius: 999px;
                    flex: 0 0 auto;
                    background: <?php echo e($toastType === 'success' ? '#34d399' : ($toastType === 'error' ? '#f87171' : '#60a5fa')); ?>;
                "
            ></span>
...
<?php /**PATH C:\Users\Admin\clean\growzio\resources\views/partials/toast.blade.php ENDPATH**/ ?>