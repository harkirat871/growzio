...
<div x-data="{ mobileOpen: false }" class="min-h-screen">
    ...
    <aside class="admin-desktop-sidebar fixed left-0 top-0 bottom-0 w-64 flex flex-col z-20" style="background: var(--admin-primary); border-right: 1px solid var(--admin-border);">
        <div class="p-4 border-b flex-shrink-0" style="border-color: var(--admin-border);">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-2 font-semibold text-lg" style="color: var(--admin-text); text-decoration: none;">
                <span style="color: var(--admin-accent);">●</span> <?php echo e(config('app.name')); ?> Admin
            </a>
        </div>
        <nav class="flex-1 p-3 space-y-0.5 overflow-y-auto" style="max-height: calc(100vh - 220px);">
            ...
            <a href="<?php echo e(route('admin.products.index')); ?>" class="admin-sidebar-link <?php echo e(request()->routeIs('admin.products.*') ? 'active' : ''); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                Products
            </a>
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="admin-sidebar-link <?php echo e(request()->routeIs('admin.orders.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.customers.index')); ?>" class="admin-sidebar-link <?php echo e(request()->routeIs('admin.customers.*') ? 'active' : ''); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                Customers
            </a>
            <a href="<?php echo e(route('admin.categories.index')); ?>" class="admin-sidebar-link <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('home')); ?>" class="admin-sidebar-link mt-2" style="color: var(--admin-accent);">
        ...
        <div class="p-3 border-t flex-shrink-0" style="border-color: var(--admin-border);">
            <div class="text-xs" style="color: var(--admin-text-muted);"><?php echo e(Auth::user()->name); ?></div>
    ...
    <header class="fixed top-0 right-0 left-0 lg:left-64 z-30 flex items-center justify-between px-4 py-3 h-14" style="background: var(--admin-primary); border-bottom: 1px solid var(--admin-border);">
        ...
        <span class="lg:hidden font-medium" style="color: var(--admin-text);"><?php echo e(config('app.name')); ?> Admin</span>
        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 px-3 py-2 rounded text-sm font-medium" style="background: rgba(37,99,235,0.2); color: #60a5fa; text-decoration: none;">
    ...
    <aside :class="mobileOpen ? 'open' : ''" class="admin-mobile-sidebar fixed left-0 top-0 bottom-0 w-64 z-50 lg:hidden flex flex-col" style="background: var(--admin-primary); border-right: 1px solid var(--admin-border); transition: transform 0.2s ease;">
        <div class="p-4 pt-16 border-b flex-shrink-0 space-y-1" style="border-color: var(--admin-border);">
            <a href="<?php echo e(route('admin.dashboard')); ?>" @click="mobileOpen = false" class="admin-sidebar-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">Home</a>
            <a href="<?php echo e(route('admin.products.index')); ?>" @click="mobileOpen = false" class="admin-sidebar-link <?php echo e(request()->routeIs('admin.products.*') ? 'active' : ''); ?>">Products</a>
            <a href="<?php echo e(route('admin.orders.index')); ?>" @click="mobileOpen = false" class="admin-sidebar-link <?php echo e(request()->routeIs('admin.orders.*') ? 'active' : ''); ?>">Orders</a>
            <a href="<?php echo e(route('admin.customers.index')); ?>" @click="mobileOpen = false" class="admin-sidebar-link <?php echo e(request()->routeIs('admin.customers.*') ? 'active' : ''); ?>">Customers</a>
            <a href="<?php echo e(route('admin.categories.index')); ?>" @click="mobileOpen = false" class="admin-sidebar-link <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>">Catalog</a>
            <a href="<?php echo e(route('home')); ?>" class="admin-sidebar-link mt-2">Back to store →</a>
        </div>
    </aside>
    ...
    <main class="admin-main pt-14 lg:pl-64" style="min-height: 100vh;">
        <div class="p-4 sm:p-6 lg:p-8">
            <?php if(session('success')): ?>
                <div class="mb-6 rounded-lg px-4 py-3 text-sm" style="background: rgba(34,197,94,0.15); border: 1px solid rgba(34,197,94,0.3); color: #4ade80;"><?php echo e(session('success')); ?></div>
            <?php endif; ?>
            <?php if(session('error')): ?>
                <div class="mb-6 rounded-lg px-4 py-3 text-sm" style="background: rgba(239,68,68,0.15); border: 1px solid rgba(239,68,68,0.3); color: #f87171;"><?php echo e(session('error')); ?></div>
            <?php endif; ?>
            <?php if($errors->any()): ?>
...
<?php /**PATH C:\Users\Admin\clean\complete ecom before mass upload - Copy\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>