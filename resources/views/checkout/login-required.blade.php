...
<head>
  ...
  <!-- Preconnect & Fonts (exactly as original) -->
  ...
  <style>
    /* =============================================
       GROWZIO — DESIGN SYSTEM (preserved exactly)
       ============================================= */
    :root {
      --g-bg: #222831;
      --g-bg2: #393e46;
      ...
      /* additional theme variables (merged from original second block) */
      --background: #222831;
      --foreground: #eeeeee;
      --border: #1f2933;
      --input: #222831;
    ...
    * {
    ...
    /* Responsive wrapper — replaces fixed 1440px width */
    .export-wrapper {
      width: 100%;
      max-width: 480px;   /* keeps container compact like original, but fluid */
      margin: 0 auto;
      display: flex;
      align-items: center;
      justify-content: center;
    ...
    /* Login container — same design, no changes */
    .g-login-container {
      width: 100%;
...
<body>
  ...
  <!-- 
    ============================================
    FIXED ALIGNMENT: 
    - No fixed width (1440px removed)
    - Fully responsive on PC & phone
    - Design untouched, only container adapts
    ============================================
  -->
  <div class="export-wrapper">
    <div class="g-login-container">
      ...
      <div class="g-login-subtitle">
        To complete your purchase and access exclusive features, please log in.
      </div>

      <!-- Benefits (same as original) -->
      ...
      <!-- CTA: Login (using placeholder route, unchanged) -->
      <a href="{{ route('login') }}" class="g-btn-block" data-media-type="banani-button">
        Log in to continue
      </a>

      <div class="g-signup-text">
        Don't have an account?
        <a href="{{ route('register') }}" data-media-type="banani-button">Create new</a>
      </div>

      <div class="g-divider"></div>

      <a href="{{ route('cart.view') }}" class="g-link" data-media-type="banani-button">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <!-- Iconify (kept exactly as provided) -->
  <script src="https://code.iconify.design/iconify-icon/3.0.0/iconify-icon.min.js"></script>
  
  <!-- 
    Note: The original second style block (duplicate root) is merged above.
    All design tokens are preserved. Only alignment fixed.
  -->
</body>
</html>