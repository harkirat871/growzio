        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="g-form-group">
                ...
                <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name"
                    ...
                    class="g-input">
                @error('name')<p class="g-error">{{ $message }}</p>@enderror
            </div>
            ...
            <div class="g-form-group">
                ...
                <input id="business_name" type="text" name="business_name" value="{{ old('business_name') }}" autocomplete="organization"
                    ...
                    class="g-input">
                @error('business_name')<p class="g-error">{{ $message }}</p>@enderror
            </div>
            ...
            <div class="g-form-group">
                ...
                <input id="gst_number" type="text" name="gst_number" value="{{ old('gst_number') }}"
                    ...
                    maxlength="20"
                    class="g-input">
                @error('gst_number')<p class="g-error">{{ $message }}</p>@enderror
            </div>
            ...
            <div class="g-form-group">
                ...
                <input id="contact_number" type="tel" name="contact_number" value="{{ old('contact_number') }}" required autocomplete="tel"
                    ...
                    maxlength="14"
                    class="g-input">
                @error('contact_number')<p class="g-error">{{ $message }}</p>@enderror
            </div>

            <!-- Station / Area -->
            <div class="g-form-group">
                <label for="station" class="g-label">Station / Area</label>
                <input id="station" type="text" name="station" value="{{ old('station') }}" required autocomplete="address-level2"
                    placeholder="e.g. Andheri, Mumbai"
                    class="g-input">
                @error('station')<p class="g-error">{{ $message }}</p>@enderror
            </div>
            ...
            <div class="g-form-group">
                ...
                <input id="referred_by" type="text" name="referred_by" value="{{ old('referred_by') }}"
                    ...
                    class="g-input">
                @error('referred_by')<p class="g-error">{{ $message }}</p>@enderror
            </div>

            <div class="g-form-actions">
                <a href="{{ route('login') }}" class="g-link">
